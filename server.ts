...
- Payments: Real secure 3DS card processor which enforces bank validation.
...
MapStore respects client security and operates under strict South African cyber safety provisions. Please enter only legitimate questions.`,
  ...
  if (textLower.includes('commission') || textLower.includes('fee') || textLower.includes('7%')) {
    ...
    reply = "To start selling on MapStore, register through the Seller portal. You will need to complete our Identity Verification (using our live real ID Scanner) and upload a Proof of Address document. Applications are securely reviewed and approved within 24 hours.";
